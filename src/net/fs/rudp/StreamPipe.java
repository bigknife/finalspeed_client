...
public class StreamPipe {
	...
	public StreamPipe(ConnInfo ci, final DataInputStream is, final DataOutputStream os, int BUF_SIZE1,
			final int maxSpeed, final byte[] preReadData, final int preReadDataLength) {
		connInfo = ci;
		...
		Runnable thread = new Runnable() {
			...
			public void run() {
				...
				try {
					if (preReadData != null) {
						// String string=new
						// String(preReadData,0,preReadDataLength);
