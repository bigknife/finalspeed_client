...
public class PortMapProcess implements ClientProcessorInterface {
	...
	public PortMapProcess(MapClient mapClient, Route route, final Socket srcSocket, String serverAddress2,
			int serverPort2, String password_proxy_md5, String dstAddress, final int dstPort) {
